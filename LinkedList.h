...
/**
 * @brief Add a node with data at the beginning of a list.
 *
...
/**
 * @brief Free the node at the start of a list and returns a pointer
 * to its data.
 *
...
/**
 * @brief Add a node with data at the end of a list.
 *
 * @param list List to add the node to.
 * @param node Node to add.
 */
 ...
 */
void llSort(List *list, int (*compare)(void *, void *));
